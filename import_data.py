...
try:
   ...
   connection = psycopg2.connect(user="postgres", database = "pwtc",
                                  password="pd1085",host="127.0.0.1")
...
(
  ...
  CONSTRAINT enforce_srid_the_geom CHECK (st_srid(the_geom) = 4326)
   ...
   #insertion of data
   insert_data = """ copy landmarks(name,gid,address,date_built,architect,landmark,latitude,longitude) FROM '/home/administrator/Desktop/system_integration/project/Individual_Landmarks.csv' DELIMITERS ',' CSV HEADER """
